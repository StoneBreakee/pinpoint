...
/**
 * 通过JMX ManagementFactory.MXBean得到启动的参数，通过遍历参数得到javaagent参数中jar包的位置
...
public class JavaAgentPathResolver {
    ...
    // RuntimeMXBean 用于管理运行时Java虚拟机的接口
    // RuntimeMXBean接口有ManagementFactory.MXBean实现，其实例可以通过ManagementFactory.getRuntimeMXBean()获得
    @VisibleForTesting
